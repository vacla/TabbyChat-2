...
public class PropertyConfiguration extends Configuration {
  ...
  /**
   * @see mnm.mods.tabbychat.redist.com.swabunga.spell.engine.Configuration#getBoolean(String)
   */
  ...
  /**
   * @see mnm.mods.tabbychat.redist.com.swabunga.spell.engine.Configuration#getInteger(String)
   */
  ...
  /**
   * @see mnm.mods.tabbychat.redist.com.swabunga.spell.engine.Configuration#setBoolean(String, boolean)
   */
  ...
  /**
   * @see mnm.mods.tabbychat.redist.com.swabunga.spell.engine.Configuration#setInteger(String, int)
   */
